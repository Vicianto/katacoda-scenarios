A web server is computer software which accepts requests via HTTP or its secure variant HTTPS. To simplify it it is a server <--> client communication which have two parts:
 1. The server itself.
 2. Web or user agent.
